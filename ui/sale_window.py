"""Sale window for recording sales."""
...
class SaleWindow(QWidget):
    """Window for recording sale transactions."""
    ...
    def on_product_selected(self):
        """Auto-populate rate based on party and product."""
        if self.party_combo.currentData() and self.product_combo.currentData():
            rate = PricingService.get_sale_rate(
    ...
    def save_sale(self):
        ...
        success, message, sale_id = InventoryService.create_sale(
            party_id, sale_date, items, invoice_number, notes
        )
